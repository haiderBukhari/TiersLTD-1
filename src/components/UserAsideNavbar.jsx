...
const UserAsideNavbar = ({ show, setShow }) => {
    return (
        <div className='w-full md:w-auto'>
            ...
            <div  className={`bg-[#242A48] bg-opacity-30 md:w-[273px] pb-10 md:pb-0 md:h-[500px] relative md:block ${show ? 'block pl-3 ml-[-15px] md:ml-1 w-[240px] z-30 bg-[#242A48] h-[480px] bg-opacity-60' : 'hidden md:block h-auto w-full'}`} style={{ borderTopRightRadius: "20px", borderBottomRightRadius: "20px", zIndex: 10, width: `${show} && 240px`, height: `${show} && 480px`}}>
