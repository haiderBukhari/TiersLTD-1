                ...
                <div className="bg-[rgba(36,42,72)] bg-opacity-50" style={{ borderRadius: "20px", height: "500px", maxWidth: "900px", width: "100%" }}>
                    <div className='flex flex-col w-full py-5 px-5 md:px-10'>
                        ...
                        <div className='bg-[#1A1B23] mt-2 rounded-lg py-2 flex px-5 justify-between w-full'>
                            <h1 className='text-white text-md md:text-xl font-bold'>S19j-19998</h1>
                            <h1 className='text-[#18A786] text-md md:text-xl font-bold'>Aktiv</h1>
                        </div>
                        <div className='bg-[#1A1B23] mt-2 rounded-lg py-2 flex px-5 justify-between w-full'>
                            <h1 className='text-white text-md md:text-xl font-bold'>10.58 LTC</h1>
                            <h1 className='text-[#18A786] text-md md:text-xl font-bold'>LTC abheben</h1>
                        </div>
                        <div className='bg-[#1A1B23] mt-2 rounded-lg py-2 flex px-5 justify-between w-full'>
                            <h1 className='text-white text-md md:text-xl font-bold'>Sie verwenden ein externes Wallet </h1>
                            <h1 className='text-[#F89423] text-md md:text-xl font-bold'>Mining Pool ändern</h1>
                        </div>
                    </div>
                </div>
            </div>
