    ...
    return (
        <div className="relative overflow-hidden min-h-[300vh]">
            ...
            <div className="px-[100px]">
                ...
                <div className="bg-zinc-900 min-h-[1009px] p-10 rounded-[107px] relative" style={{ zIndex: 12 }}>
                    <div className="flex justify-between items-center">
                        ...
                        />
                        <div className="bg-[#272E51] pb-16 py-3 px-5 max-w-[661px] w-full min-h-[495px] h-full rounded-[32px]">
                            ...
                            <div className="flex items-center mt-2">
                                <p className="text-xl text-white text-center">SwissMine GmbH Aaragauerstrasse 10 5734 Reinach AG</p>
                                <img src={map} alt='' />
                            </div>
                            <div className="pt-16">
                                <div className="justify-center w-full max-md:max-w-full text-3xl font-bold text-white mt-1">
